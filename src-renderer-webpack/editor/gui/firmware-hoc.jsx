...
import {setCode,getCode} from '../../../utils/global.js'
// import { setExtension } from '../../../utils/extensionWho.js';
...
const handleClickMaster = () => {
    EditorPreload.openMasterWindow()
    // setExtension(true)

}
const handleClickConnect= () =>{
    // console.log('*************************')
    EditorPreload.openConnectWindow()
}
...
const handleClickFirmware = () =>{
    EditorPreload.openDownloadSettings(codeModule.getCode())
}
...
const FirmwareHOC = function (WrappedComponent) {
  class FirmwareComponent extends React.Component {
    constructor (props) {
      super(props);
      this.state = {
        title: ''
    ...
    render() {
      ...
      return (
        <WrappedComponent
          onClickFirmware={handleClickFirmware}
          {...props}
        />
      );
    }
